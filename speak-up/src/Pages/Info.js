...
export default function Info() {
    return (
      <section className='block bg-white md:flex md:items-center text-white py-16 mx-auto md:text-left text-center'>
          ...
          <div className='md:flex-1 px-12'>
              <h2 className='text-3xl  md:mb-0 mb-4 text-black'>Become an instructor</h2>
              ...
              <button className='px-4 py-2 md:mt-0 mt-8 bg-black text-white p-2 md:w-auto w-full'>Get Started</button>
          </div>
      </section>
    )
  }