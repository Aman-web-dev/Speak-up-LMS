...
function Facts() {
  return (
    ...
    <div className='grid  grid-cols-1 my-7 w-[90%] m-auto h-[50%] md:h-[100%] sm:h-[100%] lg:h-[50%]'>
    <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Facts</h1>
